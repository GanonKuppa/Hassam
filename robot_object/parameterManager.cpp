...
namespace robot_object{
    ...
    void ParameterManager::init(){
        ...
        registration<uint8_t>(100, goal_x);
        registration<uint8_t>(101, goal_y);
        registration<uint8_t>(102, half_flag);
        registration<uint16_t>(103, front_wall_center_r);
        registration<uint16_t>(104, front_wall_center_l);
        registration<uint16_t>(105, back_wall_center_r);
        registration<uint16_t>(106, back_wall_center_l);
        registration<uint16_t>(107, front_collision_thr_ahead);
        registration<uint16_t>(108, back_collision_thr_ahead);
        registration<uint16_t>(109, front_wall_threshold_right);
        registration<uint16_t>(110, front_wall_threshold_left);
        registration<uint16_t>(111, front_wall_threshold_ahead);
        registration<uint16_t>(112, back_wall_threshold_right);
        registration<uint16_t>(113, back_wall_threshold_left);
        registration<uint16_t>(114, back_wall_threshold_ahead);
        registration<uint16_t>(115, HF_front_wall_center_r);
        registration<uint16_t>(116, HF_front_wall_center_l);
        registration<uint16_t>(117, HF_back_wall_center_r);
        registration<uint16_t>(118, HF_back_wall_center_l);
        registration<uint16_t>(119, HF_front_collision_thr_ahead);
        registration<uint16_t>(120, HF_back_collision_thr_ahead);
        registration<uint16_t>(121, HF_front_wall_threshold_right);
        registration<uint16_t>(122, HF_front_wall_threshold_left);
        registration<uint16_t>(123, HF_front_wall_threshold_ahead);
        registration<uint16_t>(124, HF_back_wall_threshold_right);
        registration<uint16_t>(125, HF_back_wall_threshold_left);
        registration<uint16_t>(126, HF_back_wall_threshold_ahead);
        registration<float>(127, v_search_run);
        registration<float>(128, HF_v_search_run);
